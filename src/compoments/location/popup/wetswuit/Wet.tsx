...
export default function Wet({off} : {off : () => void}) {
    ...
    const [state1, setState1] = useState<pre>(mat.wet?.length && mat.wet.length > 0 ? { a : mat.wet[0].time, b : mat.wet[0].quantite} : {a : undefined, b : undefined})
    const [state2, setState2] = useState<pre>(mat.wet?.length && mat.wet.length > 1 ? { a : mat.wet[1].time, b : mat.wet[1].quantite} : {a : undefined, b : undefined})
    const [state3, setState3] = useState<pre>(mat.wet?.length && mat.wet.length > 2 ? { a : mat.wet[2].time, b : mat.wet[2].quantite} : {a : undefined, b : undefined})
  ...
  return (
    <div className={style.wrapper} ref={main}>
        ...
        <div>
            <Layout rmcount={()=>{off(); setMat({...mat, wet : undefined})}}>
    ...
    return(
        <section className={style.content}>
            ...
            <div className={style.box}>
                ...
                <div>
                    <p>Sous-total {count*getPriceWet(select!) ? count*getPriceWet(select!)  : 0} €</p>
                </div>
            </div>
